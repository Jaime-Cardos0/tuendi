...
export function Sidebar(){
    return(
        <Box as="aside" w={48} h={"100vh"} position={"fixed"} top={20} left={0} pl={6} pr={2} pt={6} zIndex={1000} bgColor={"bg.default"} borderRightWidth={1} borderColor={"navy.700"} boxShadow={"0 8px 32px rgba(0, 0, 0, 0.3)"}>
