...
export function Sidebar(){
    return(
        <Box as="aside" w={48} h={"100vh"} position={"fixed"} top={22} pt={2} left={0} pl={6} pr={2} zIndex={1000} bgColor={"bg.default"} borderRightWidth={1} borderColor={"border.default"} boxShadow={"dark-lg"}>
